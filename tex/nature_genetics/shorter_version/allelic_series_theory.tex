...
Sleuth~\cite{Pimentel2016a} (see~\nameref{sec:methods}). Differential expression
...
Phenotypic Classes Notebook}). \todo[inline]{Note: the bx93-associated class is
actually 3 classes merged together. 2 of these classes aren't DE in all 3
genotypes (only 2 each), but my analyses strongly suggest this is the result of
false negatives}
